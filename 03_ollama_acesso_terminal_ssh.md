...
## 🔗 Notas Relacionadas
- [Benchmark Modelos MoE no GEEKOM](01_benchmark_modelos_moe_geekom.md) — Desempenho dos modelos testados no host de inferência.
- [Sincronização com SyncThing](04_ollama_sincronizacao_syncthing.md) — Sincronização bidirecional de notas e prompts com o servidor.
- [Arquitetura RAG Nativo Local](05_arquitetura_rag_nativo_hermes_db.md) — Integração do Ollama com agentes inteligentes via MCP.
- [Guia Principal de Inteligência Artificial](README.md) — Índice principal.
