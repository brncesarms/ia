...
## 🔗 Notas Relacionadas
- [Acesso ao Ollama via Terminal SSH](03_ollama_acesso_terminal_ssh.md) — Operação remota dos modelos via SSH.
- [Arquitetura RAG Nativo Local](05_arquitetura_rag_nativo_hermes_db.md) — Base de dados unificada da Tríade de computação.
